...
#write a program after creating a list with even numbers within the range 1 to 15 now apply lambda function and create a new list it should have square roots of the elements
'''import math
L=[2,4,6,8,10,12,14]
